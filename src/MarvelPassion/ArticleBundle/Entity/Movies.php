...
/**
 * @ORM\Entity(repositoryClass="App\MarvelPassion\ArticleBundle\Repository\MoviesRepository")
...
class Movies
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\MarvelPassion\CommentBundle\Entity\Comments", mappedBy="movie")
     * @ORM\OrderBy({"creationDate" = "DESC"})
     */
    private $comments;

    /**
     * @ORM\ManyToOne(targetEntity="App\MarvelPassion\UserBundle\Entity\Users", inversedBy="movies")
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\MarvelPassion\ShootingBundle\Entity\Shootings", mappedBy="movie")
     */
    private $shootings;
