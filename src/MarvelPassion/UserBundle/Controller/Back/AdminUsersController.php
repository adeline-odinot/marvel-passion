...
namespace App\MarvelPassion\UserBundle\Controller\Back;

use App\MarvelPassion\UserBundle\Entity\Role;
use App\MarvelPassion\UserBundle\Entity\Users;
use App\Service\Paginator;
use App\MarvelPassion\UserBundle\Form\AdminUserType;
use App\MarvelPassion\UserBundle\Repository\UsersRepository;
...
class AdminUsersController extends AbstractController
{
    ...
    public function index($page = 1, Paginator $paginator)
    {
        ...
        return $this->render('UserBundle/Ressources/views/Back/user/index.html.twig', [
            'paginator' => $paginator
        ]);
    }
    ...
    public function addRole(Users $user, UsersRepository $repo, $id, Request $request, ObjectManager $manager)
    {
        ...
        return $this->render('UserBundle/Ressources/views/Back/user/editRole.html.twig',
            [
                'tabRole' => $tabRole,
                'user' => $user,
